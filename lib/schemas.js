...
const tools = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        minScore: {
          type: "number",
          description: "Pontuação mínima de relevância RRF para filtrar notas irrelevantes (ex: 0.01)."
        }
      }
    }
  },
    ...
    inputSchema: {
      ...
      properties: {
        action: {
          ...
          description: "Ação: 'list' (listar diretrizes), 'read' (ler diretriz), 'write' (salvar/atualizar diretriz)."
        },
        type: {
          type: "string",
