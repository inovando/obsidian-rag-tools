...
function handleGetMcpMetrics() {
  ...
  const report = [
    ...
    `  * Erros de validação evitados (total): ${m.validationErrorsPrevented}`,
    `    - Recusados por Formato (YAML/limites): ${m.formatErrorsPrevented}`,
    `    - Recusados por Regra de Conteúdo (placeholders): ${m.contentRulesPrevented}`,
